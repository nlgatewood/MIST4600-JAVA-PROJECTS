...
public class SuspectCharacters
{
    ...
    public SuspectCharacters()
    {
        ...
        suspectCharacters.add(new Character("Miss Redding", "Even though she's young, cunning, and highly attractive you get the sense she's not what "+
        ...
        suspectCharacters.add(new Character("Colonel Lugar", "Quite the dapper military man.  Wearing a tweed suit and sporting white fuzzy mutton chops, "+
        ...
        suspectCharacters.add(new Character("Mrs. Maroon", "Wearing the traditional house-maid garb, she appears to be a servant.  The first thing you "+
        ...
        suspectCharacters.add(new Character("Mr. Mauve", "Judging from his collar, he appears to be a man of the cloth.  His demeanor is very pleasant, "+
        ...
        suspectCharacters.add(new Character("Mrs. Chicken", "An elderly, yet elegant aristocrat.  She bears a Queen-like resemblance with the diamond "+
        ...
        suspectCharacters.add(new Character("Professor Plunk", "A youthful pontificating scientist, he quickly gets on your nerves.  His thick glasses "+
