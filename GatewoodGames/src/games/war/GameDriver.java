...
public class GameDriver
{
    ...
    public  void playGame()
    {
        ...
        do
        {
            ...
            else if(userInput.equals(""))//(userInput.equals("d"))
            {
                roundCnt++;
                System.out.println("\n==============================================================\nRound "+ roundCnt+"\n");
    ...
    /**
     * .playRound().
     * Play a round of War.  Each person draws a card.  The highest wins.
     */
    ...
    /**
     * .dealCards().
     * Deal out the cards to each of the players. Each player should get 26 cards each
     */
    ...
    /**
     * .getCardRank.
     * Get the specified card's game rank.  If a null card is passed, keep the rank at 0
     */
    ...
    /**
     * .getDrawMessage(Card playerCard, int cardRank).
     * Create the message printed after a player draws a card.  Different depending on # of cards left
     */
    ...
    /**
     * .getScores(int playerNum).
     * Get the score (card count) of the specified player
     */
